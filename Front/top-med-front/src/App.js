    ...
    <header className="App-header">
      <div className="modal-container">
        <div className="modal-branco">
          ...
          <div className="row">
            <p className="esqueceu-senha-texto" onClick={abrirTela2}>
              Esqueceu sua senha?
            </p>
          </div>
          <div className="row">
            <button className="Botao_entrar" onClick={handleClick}>
              <p className="entrar-texto">ENTRAR</p>
            </button>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
            <img
              src={topmed_logo}
              className="TopMed-logo"
              alt="topmed_logo"
              style={{ gridColumn: "1", marginRight: "10px" }}
            />
            <img
              src={nextplus_logo}
              className="nextplus-logo"
              alt="nextplus_logo"
              style={{ gridColumn: "2" }}
            />
          </div>
        ...
        <div className="modal-verde">
          ...
          <div className="row">
            <p className="teste-acessos-texto">
          ...
          <div className="row">
            <button className="Botao_teste" onClick={abrirTela3}>
              <p className="realizar-teste-texto">Realizar Teste</p>
            </button>
          </div>
        </div>
      </div>
